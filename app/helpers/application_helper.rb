module ApplicationHelper
   ...
   def source_helper(styles)
      if session[:source]
         greeting = "Thank you for visiting me from <strong>#{ session[:source] }</strong>, please feel free to <strong>#{ link_to 'contact me', contact_path }</strong> if you'd like to work together."
